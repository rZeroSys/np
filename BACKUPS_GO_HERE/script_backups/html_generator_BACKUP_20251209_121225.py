...
/* LEADERBOARD DRAWER - slides out from right */
.leaderboard-drawer {
    position: fixed;
    top: 133px;
    right: 0;
...
/* Leaderboard drawer toggle button - RIGHT side */
...
.leaderboard-drawer-toggle:hover {
    background: #004499;
    padding-right: 14px;
}

.leaderboard-drawer.open + .leaderboard-drawer-toggle,
body.leaderboard-drawer-open .leaderboard-drawer-toggle {
    right: 300px;
}
...
/* Hide leaderboard on All Buildings tab */
body.all-buildings-active .leaderboard-drawer,
body.all-buildings-active .leaderboard-drawer-toggle {
...
<div class="leaderboard-drawer" id="leaderboard-drawer">
    <div class="filter-drawer-header">
        <span class="sidebar-label">Most Active Users</span>
        <button class="filter-drawer-close" onclick="toggleLeaderboardDrawer()">&times;</button>
    </div>
    <div id="lb-controls-drawer" style="display:flex;gap:8px;align-items:center;margin-bottom:12px;">
        <button id="lb-refresh-drawer" style="padding:6px 12px;border:1px solid #ddd;border-radius:6px;background:white;cursor:pointer;font-size:12px;">Refresh</button>
        <span id="lb-updated-drawer" style="font-size:11px;color:#888;"></span>
    </div>
    <ul class="leaderboard-list" id="leaderboard-list">
        <li class="leaderboard-item" style="color:#888;">Loading...</li>
    </ul>
</div>
<button class="leaderboard-drawer-toggle" onclick="toggleLeaderboardDrawer()">Leaderboard</button>'''
    ...
    <!-- Visitor Leaderboard Script (Drawer) -->
    <script>
    (function(){{
      ...
      const btn  = document.getElementById('lb-refresh-drawer');
      const info = document.getElementById('lb-updated-drawer');
      if (!list || !btn) return;
...
function toggleLeaderboardDrawer() {{
    ...
    drawer.classList.toggle('open');
    document.body.classList.toggle('leaderboard-drawer-open');
}}
