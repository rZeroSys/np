...
"""
    ...
    def build_tenant_with_sub(tenant_name, sub_name):
        ...
        if sub_name:
            ...
            # Just show logos - td has text-align:center
            if sub_logo and tenant_logo and sub_logo != tenant_logo:
                return f"{tenant_logo} &nbsp;&nbsp; {sub_logo}"
            elif sub_logo:
                return sub_logo
            elif tenant_logo:
                return tenant_logo
    ...
    # Style for td when showing centered logos
    td_center = " style='text-align:center !important;'" if tenant_sub else ""
