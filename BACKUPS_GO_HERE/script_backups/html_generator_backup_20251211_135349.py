...
{sidebar_html}'''
    ...
    <div class="vertical-filter-inner">
        ...
        <span class="info-tooltip" data-tooltip="Click the arrow on each button to see building type filters specific to that industry vertical.">i</span>
        ...
        <span class="info-tooltip tooltip-right" style="margin-left: 8px; z-index: 1010;" data-tooltip="Use the map to see the geographic distribution of a selected portfolio, or check if we have a specific building by searching its address.">i</span>
    </div>
</div>'''
