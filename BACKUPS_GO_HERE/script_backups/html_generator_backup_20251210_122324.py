    ...
    def _generate_data_files(self):
        ...
        portfolio_buildings = {
            i: [{
                ...
                'loc_address': b.get('loc_address', ''),
                'loc_city': b.get('loc_city', ''),
                'loc_state': b.get('loc_state', ''),
                'id_property_name': self._get_display_name(b),
                ...
                'energy_eui_benchmark': b.get('energy_eui_benchmark', 0) or 0,
                'image': b.get('image', ''),
        ...
        export_data = [{
            ...
            'org_tenant': self._get_org_display_name(b.get('org_tenant', '')),
            'org_manager': self._get_org_display_name(b.get('manager', '')),
            'sqft': b.get('sqft', 0) or 0,
            'bldg_year_built': b.get('bldg_year_built', ''),
            'opex': b.get('total_opex', 0) or 0,
            'valuation': b.get('valuation_impact', 0) or 0,
            'carbon': b.get('carbon_reduction', 0) or 0,
            'energy_site_eui': b.get('energy_site_eui', 0) or 0,
            'energy_eui_benchmark': b.get('energy_eui_benchmark', 0) or 0,
            'bldg_vertical': b.get('bldg_vertical', ''),
            'image': b.get('image', '')
...
<div class="all-buildings-section" style="padding: 190px 32px 20px 32px;">
    ...
    <div class="cities-header">
        <span></span>
        <span onclick="sortAllBuildings('loc_address')">Address</span>
        ...
        <span onclick="sortAllBuildings('org_tenant')">Tenant</span>
        <span onclick="sortAllBuildings('org_manager')">Prop Mgr</span>
...
function doFilterAllBuildings() {{
    ...
    filteredBuildingsData = allBuildingsData.filter(b => {{
        // City filter
        if (selectedCityFilter && b.loc_city !== selectedCityFilter) return false;
