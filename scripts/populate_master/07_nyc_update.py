...
def build_nyc_row(bbl, data):
    ...
    # Utilization rate - estimated from vacancy
    utilization_rate = max(0.35, 0.70 - vacancy_rate)  # Higher vacancy = lower utilization
    ...
    # Gas cost
    gas_rate = NYC_DEFAULTS['cost_gas_rate_therm']
    ...
    row = {
        ...
        'cost_elec_rate_kwh': NYC_DEFAULTS['cost_elec_rate_kwh'],
        'cost_utility_name': NYC_DEFAULTS['cost_utility_name'],
        'cost_elec_energy_annual': annual_energy_cost,
        'cost_elec_load_factor': NYC_DEFAULTS['cost_elec_load_factor'],
        'cost_elec_peak_kw': estimated_peak_kw,
        'cost_elec_rate_demand_kw': demand_rate_per_kw,
        'cost_elec_demand_annual': annual_demand_cost,
        'cost_elec_total_annual': total_annual_electricity_cost,
        'cost_calc_notes': NYC_DEFAULTS['cost_calc_notes'],
        'cost_gas_annual': annual_gas_cost,
        'cost_gas_rate_therm': NYC_DEFAULTS['cost_gas_rate_therm'],
        'cost_steam_annual': None,
        'cost_steam_rate_mlb': None,
