...
Formulas:
  ...
  odcv_carbon_reduction_yr1_mt = (energy_elec_kbtu × hvac_pct_elec × odcv_pct × elec_factor)
                               + (energy_gas_kbtu × hvac_pct_gas × odcv_pct × gas_factor)
                               + (energy_steam_kbtu × hvac_pct_steam × odcv_pct × steam_factor)
                               + (energy_fuel_oil_kbtu × hvac_pct_fuel_oil × odcv_pct × fuel_oil_factor)
